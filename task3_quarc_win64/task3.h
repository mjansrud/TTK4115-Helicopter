...
#define task3_rtModel                  RT_MODEL_task3_T
...
#define rtB                            task3_B
#define BlockIO                        B_task3_T
#define rtX                            task3_X
#define ContinuousStates               X_task3_T
#define rtXdot                         task3_XDot
#define StateDerivatives               XDot_task3_T
#define tXdis                          task3_XDis
#define StateDisabled                  XDis_task3_T
#define rtP                            task3_P
#define Parameters                     P_task3_T
#define rtDWork                        task3_DW
#define D_Work                         DW_task3_T
...
extern P_task3_T task3_P;

/* Block signals (auto storage) */
extern B_task3_T task3_B;

/* Continuous states (auto storage) */
extern X_task3_T task3_X;

/* Block states (auto storage) */
extern DW_task3_T task3_DW;
...
extern void task3_output0(void);
extern void task3_update0(void);
extern void task3_output(int_T tid);
extern void task3_update(int_T tid);
 ...
 * '<S2>'   : 'task3/Heli 3D'
 * '<S3>'   : 'task3/Joystick'
 * '<S4>'   : 'task3/Pitch controller1'
 * '<S5>'   : 'task3/Heli 3D/Elevation rad to deg'
 * '<S6>'   : 'task3/Heli 3D/Elevation rate rad to deg'
 * '<S7>'   : 'task3/Heli 3D/Pitch rad to deg'
 * '<S8>'   : 'task3/Heli 3D/Pitch rate rad to deg'
 * '<S9>'   : 'task3/Heli 3D/Travel rad to deg'
 * '<S10>'  : 'task3/Heli 3D/Travel rate  rad to deg'
 */

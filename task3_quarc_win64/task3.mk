...
MODEL                = task3
MODULES              = rtGetInf.c rtGetNaN.c rt_nonfinite.c task3_data.c task3_main.c 
MAKEFILE             = task3.mk
...
MODELLIB                  = task3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = task3_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\task3_quarc_win64
